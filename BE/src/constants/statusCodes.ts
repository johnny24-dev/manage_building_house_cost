...
export const SuccessMessages: Record<SuccessCode, string> = {
  ...
  [SuccessCode.OTP_SENT]: 'Mã OTP đã được gửi',
  [SuccessCode.OTP_VERIFIED]: 'Mã OTP đã được xác thực',
...
export const ErrorMessages: Record<ErrorCode, string> = {
  ...
  [ErrorCode.OTP_EXPIRED]: 'Mã OTP đã hết hạn',
  [ErrorCode.OTP_NOT_VERIFIED]: 'Mã OTP chưa được xác thực',
...
export const ErrorHttpStatus: Record<ErrorCode, number> = {
  ...
  [ErrorCode.OTP_NOT_VERIFIED]: 400,
...
export const SuccessHttpStatus: Record<SuccessCode, number> = {
  ...
  [SuccessCode.OTP_SENT]: 200,
  [SuccessCode.OTP_VERIFIED]: 200,
